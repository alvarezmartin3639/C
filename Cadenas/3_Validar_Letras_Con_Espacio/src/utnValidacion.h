...
/**
 * @fn int esNumeroTelefonico(char*)
 * @brief valida si una cadena de caracteres es un numero telefonico  separado por - o no(4XXX-XXXX)
 *
 * @param pArrayNum puntero al array que va a validar que sea numero te
 * @return  1 = es numero telefonico, 0 = no es numero telefonico
 */
 ...
 *
 * @param pArrayChar puntero al array que va a validar que sea numero
 * @return  1 = es flotante , 0 = no es flotante
 */
 ...
 * @return  1 =  es flotante sin decimal, 0 =  no es flotante sin decimal
 */
 ...
 * @return  1 =  es letra, 0 =  no es letra
 */
 ...
 * @return  1 = es alfanumerico, 0 =  no es alfanumerico
 */
