 ...
 */
int mostrarEmpleados(eEmpleado *empleados, int tamEmpleado, int estaVacio, int conCabecera, int contEmpleadosActivos);
 ...
 */
int modificarEmpleados(eEmpleado *empleados, int tamEmpleado, int contEmpleadosActivos);
