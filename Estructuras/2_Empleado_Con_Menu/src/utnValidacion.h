 ...
 * @return -1 = error inesperado, 0 = sin errores
 */
int getPedirInt(int *pNumero, char *mensaje, char *mensajeError, int minimo, int maximo, int reintentos);
 ...
 * @return  -1 = error inesperado, 0 = sin errores
 */
int getPedirFloat(float *pNumero, char *mensaje, char *mensajeError, float minimo, float maximo, int reintentos);
 ...
 * @return -1 = error inesperado, 0 = sin errores
 */
int getPedirCharDeLetra(char *pChar, char *mensaje, char *mensajeError, int minimo, int maximo, int reintentos);
/**
 ...
 * @return  -1 = error inesperado, 0 = sin errores
 */
int getPedirStringDeLetrasConEspacio(char *pArrayChar, char *mensaje, char *mensajeError, int reintentos);
/**
 ...
 * @return  -1 = error inesperado, 0 = sin errores
 */
int getPedirAlfanumerico(char *pArrayChar, char *mensaje, char *mensajeError, int reintentos);
 ...
 */
int elegirEntreOpciones(char mensaje[60], char opcionUno[60], char opcionDos[60]);
