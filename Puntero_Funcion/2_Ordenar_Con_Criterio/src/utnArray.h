 ...
 * @return  -1 = error , 0 = sin error
 */
int ordenarString(char texto[][50], int tamMatrizTexto, int orden);
 ...
 * @brief busca en el array el valorBuscado pasado por parametro y  retorna el primer indice que contiene dicho valor
 *
